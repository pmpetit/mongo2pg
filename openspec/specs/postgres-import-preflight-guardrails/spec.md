# postgres-import-preflight-guardrails Specification

## Purpose

Define import preflight guardrails for PostgreSQL destination database/schema readiness, privilege-attributed failures, and early-stop protections before apply operations.
