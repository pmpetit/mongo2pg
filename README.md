...
```bash
# Replace <version> and <platform> with your values, e.g. 0.6.4 and linux-x86_64
version="X.Y.Z"
platform="linux-x86_64"
gh auth login
gh release download "v${version}" --repo pmpetit/mongo2pg --pattern "mongo2pg-${platform}"
mv "mongo2pg-${platform}" mongo2pg
chmod +x mongo2pg
sudo mv mongo2pg /usr/local/bin/
```

<https://github.com/pmpetit/mongo2pg/tree/vX.Y.Z>
